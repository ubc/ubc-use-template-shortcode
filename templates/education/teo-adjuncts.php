...
$cohort					      	= get_post_meta( absint( $post_id ), 'cohort', true );
$schooldistrict			  	= get_post_meta( absint( $post_id ), 'school-district', true );
$teachinginterests			= get_post_meta( absint( $post_id ), 'teaching-interests', true );
$outsideinterests		   	= get_post_meta( absint( $post_id ), 'outside-interests', true );
