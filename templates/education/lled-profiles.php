...
$website                          = ( isset( $profile_cct['clone_other_websites']['textarea']) ) ? $profile_cct['clone_other_websites']['textarea']: false;
             ...
             <div class="span12">
               ...
               <div class="modal-body-content">
                 ...
                 <div class="span3"><img src="<?php echo esc_url( $post_thumbnail ); ?>" alt="" />
                    ...
                    <div class="modalbtns"><a href="<?php the_permalink(); ?>" role="button" class="btn btn-small launch-btn" target="_blank">View Full Profile</a>
                 ...
                 <div class="span9">
                    ...
                    <div class="modal-iso-description">
                      ...
                      <?php endif; ?></br>
                       ...
                       <div class="bloglink"><?php if ( false !== $website ) : echo wp_kses_post( $website ); endif; ?></div>  
