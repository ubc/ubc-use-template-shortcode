...
//**
 //* A template for EDST Profiles.  http://edst.educ.ubc.ca/faculty-staff/
               ...
               <div class="modal-body-content">
                 ...
                 <div class="span3"><img src="<?php echo esc_url( $post_thumbnail ); ?>" alt="" />
                    ...
                    <div class="modalbtns"><a href="<?php the_permalink(); ?>" role="button" class="btn btn-small launch-btn" target="_blank">View Full Profile</a></br>
                       ...
                       <div class="btn btn-small launch-btn bloglink"><?php if ( false !== $website ) : echo wp_kses_post( $website ); endif; ?></div>
                 ...
                 <div class="span9">
                    ...
                    <div class="modal-iso-title">
                       ...
                       <h3><?php if ( false !== $salutations ) : echo esc_html( $salutations ); endif; ?> <?php if ( false !== $first_name ) : echo esc_html( $first_name ); endif; ?> <?php if ( false !== $middle ) : echo esc_html( $middle ); endif; ?> <?php if ( false !== $last_name ) : echo esc_html( $last_name ); endif; ?></h3>

                    </div>

                    <div class="position-colour"><?php if ( false !== $position ) : echo esc_html( $position ); endif; ?></div>
