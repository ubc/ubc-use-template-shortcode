    ...
    <div class="boxey-inside">
        ...
        <div class="boxey-inner">
          ...
          <h3><div class="iso-title">
            ...
            <?php if ( false !== $salutations ) : echo $salutations; endif; ?> <?php if ( false !== $first_name ) : echo $first_name; endif; ?> <?php if ( false !== $middle ) : echo $middle; endif; ?> <?php if ( false !== $last_name ) : echo $last_name; endif; ?>          
            <small><?php if ( false !== $position ) : echo $position; endif; ?></small></a>

          </div></h3>

          <div class="iso-description hidden">
            <?php if ( false !== $salutations ) : echo $salutations; endif; ?> 
            <?php if ( false !== $first_name ) : echo $first_name; endif; ?> 
            <?php if ( false !== $middle ) : echo $middle; endif; ?> 
            <?php if ( false !== $last_name ) : echo $last_name; endif; ?>
            <?php if ( false !== $position ) : echo $position; endif; ?> 
            <?php if ( false !== $clone_name_title_room_phone_email ) : echo $clone_name_title_room_phone_email; endif; ?> 
            <?php echo esc_html( $$plain_term_name ); ?>
          </div>

          <?php if ( false !== $clone_room_number ) : echo $clone_room_number; endif; ?></br>

          <i class="icon-envelope"></i> <a href="mailto:<?php echo esc_attr( $email );?>"><?php if ( false !== $email ) : echo $email; endif; ?></a></br>

          <i class="icon-phone-sign"></i> <?php if ( false !== $phone1 ) : echo $phone1; endif; ?> <?php if ( false !== $phone2 ) : echo $phone2; endif; ?> <?php if ( false !== $phone3 ) : echo $phone3; endif; ?></br>
               ...
               <div class="modal-body-content">
                 ...
                 <div class="span9">
                    ...
                    <div class="modal-iso-description">
                       ...
                       <i class="icon-envelope"></i> <a href="mailto:<?php echo esc_attr( $email );?>"><?php if ( false !== $email ) : echo $email; endif; ?></a>
                       <i class="icon-phone-sign"></i> <?php if ( false !== $phone1 ) : echo $phone1; endif; ?> <?php if ( false !== $phone2 ) : echo $phone2; endif; ?> <?php if ( false !== $phone3 ) : echo $phone3; endif; ?>
                    </div>
  
                    <div class="modal-postion-description"><?php if ( false !== $clone_bio ) : echo $clone_bio; endif; ?></div>
