...
/**
 * A template for Faculty of Education html within Loop or Isotope queries. Edit as needed.
 */
...
?>
	...
	<div class="boxey <?php echo esc_attr( $plain_cat_slug ); ?> boxStyle <?php echo esc_attr( $session_type ); ?> ">
		...
		<h3 class="boxTitle"><a title="<?php echo esc_attr( the_title() ); ?>" href="<?php echo esc_attr( the_permalink()); ?>" target="_blank"><?php esc_html( the_title() ); ?></h3>
