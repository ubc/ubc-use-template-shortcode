    ...
    <div class="boxey-inside">
        ...
        <div class="boxey-inner">
          ...
          <h3>
            ...
            <div class="iso-title"><a href="#modal_<?php echo absint( $post_id ); ?>" class="fancybox-inline">
            <?php echo esc_html ( $salutations);?> <?php echo esc_html ( $first_name );?> <?php echo ( $middle_name );?> <?php echo ( $last_name );?></a>
            </div>
         ...
         <div class="span12">
           ...
           <div class="modal-body-content">
              ...
              <div class="span3">
               ...
               <img src="<?php echo esc_url( $post_thumbnail ); ?>" alt="" />
             ...
             <div class="span9">
              ...
              <div class="modal-iso-title">
                ...
                <h3> <?php echo esc_html ( $salutations);?> <?php echo esc_html ( $first_name );?>  <?php echo ( $middle_name );?> <?php echo ( $last_name );?> 
                  ...
                  <i class="icon-laptop"></i> <?php echo esc_html( $website );?>

                  </div>
                  
                  <div class="modal-postion-description"><?php echo ( $bio );?>
